...
import { elapsed, toneOf } from './harness-components'
...
import { blockingReasonList, currentImplementationCouncil, mergeHarnessLedger } from './harness-state'
...
function latestCouncil(ledger: HarnessLedgerResponse): HarnessCouncilRecord | undefined {
...
function CouncilProgress({ ledger }: { ledger: HarnessLedgerResponse }) {
  const council = currentImplementationCouncil(ledger) ?? latestCouncil(ledger)
