    ...
    <div className="flex min-h-screen items-center justify-center bg-bg">
      <div className="w-full max-w-sm rounded-xl border border-border bg-bg-elevated p-8">
        ...
        <form action={signInWithGitHub}>
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-2 rounded-lg bg-[hsl(0_0%_100%/0.95)] px-4 py-2.5 text-sm font-medium text-[#24292f] transition-colors hover:bg-white"
          >
            <GitHubIcon />
            Sign in with GitHub
          </button>
