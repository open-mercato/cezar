 ...
 * CLI is **opt-in** via `CEZ_DISPATCH=1` and off by default. Off, the `/runs/:id/{dispatch,report}`
 * routes answer 409 and no task's system prompt mentions dispatching; the `dispatch` field on
 * existing run records survives the flag being unset.
 *
 ...
 *  `CEZ_DISPATCH=1` ⇒ task dispatch exists (spec 2026-09-10-dispatch).
 *
