 ...
 */
const WORKSPACE_EVENT_NAMES = ['project-added', 'project-removed', 'checkout-progress', 'automation-change', 'scheduled-task-change'] as const
    ...
    const connect = (): void => {
      ...
      for (const name of WORKSPACE_EVENT_NAMES) {
        source.addEventListener(name, (event) => {
          ...
          if (name !== 'checkout-progress' && name !== 'automation-change' && name !== 'scheduled-task-change') {
