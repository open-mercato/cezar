...
describe('the contract reaches the cockpit as BOTH a schema and a type', () => {
  it('validates at runtime', () => {
    const ok = healthResponseSchema.safeParse({
      ...
      forge: null, capabilities: { localHandoff: true, tokenMetrics: true, tokenUsageMetrics: true, costMetrics: true, followups: true, singleProject: false, automations: false, units: false },
