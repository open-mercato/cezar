...
/** The follow-up composer's optional engine, effort and account overrides. The contract owns this
 * shape, so the typed client and server cannot disagree about which fields a Continue accepts. */
