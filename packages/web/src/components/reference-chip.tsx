...
/** Border + text per status tone. The chip RESTS neutral (purple is reserved for action/active):
 *  a reference with no status known is quiet metadata, not an accent. `violet` is only what the
 *  violet-toned statuses (merged, completed, draft) paint — with the text-safe ink token. */
