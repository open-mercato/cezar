...
export interface PendingAttachment extends AttachmentInput {
  /** Server-minted id while this attachment is held by a persisted in-task draft. */
  id?: string
...
/** Distinguishes an optimistic send clear from a user edit for persisted draft hosts. */
