...
const HEALTH: HealthResponse = {
  ...
  forge: null,
  capabilities: { localHandoff: true, tokenMetrics: true, tokenUsageMetrics: true, costMetrics: true, followups: true, singleProject: false, automations: false, units: false },
}
...
describe('submit', () => {
  ...
  const inboxOffHealth: HealthResponse = {
    ...HEALTH,
    capabilities: { localHandoff: true, tokenMetrics: true, tokenUsageMetrics: true, costMetrics: true, followups: false, singleProject: false, automations: false, units: false },
  }
