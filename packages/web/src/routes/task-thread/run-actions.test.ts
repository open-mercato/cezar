...
describe('runActionFlags — the visibility matrix, all 7 statuses × archived', () => {
  ...
  const matrix: Array<{ status: RunStatus; expected: Omit<ReturnType<typeof runActionFlags>, 'notes'> }> = [
    { status: 'queued', expected: { finish: false, continueRun: false, terminal: false, archive: false, markUnread: false, pin: true, promote: true, cancel: true, deleteRun: false } },
    { status: 'running', expected: { finish: false, continueRun: false, terminal: false, archive: false, markUnread: false, pin: true, promote: false, cancel: true, deleteRun: false } },
    { status: 'waiting', expected: { finish: true, continueRun: false, terminal: false, archive: false, markUnread: false, pin: true, promote: false, cancel: true, deleteRun: false } },
    { status: 'review', expected: { finish: true, continueRun: true, terminal: true, archive: true, markUnread: false, pin: true, promote: false, cancel: false, deleteRun: true } },
    { status: 'done', expected: { finish: false, continueRun: true, terminal: true, archive: true, markUnread: false, pin: true, promote: false, cancel: false, deleteRun: true } },
    { status: 'failed', expected: { finish: false, continueRun: true, terminal: true, archive: true, markUnread: false, pin: true, promote: false, cancel: false, deleteRun: true } },
    { status: 'cancelled', expected: { finish: false, continueRun: true, terminal: true, archive: true, markUnread: false, pin: true, promote: false, cancel: false, deleteRun: true } },
  ]
