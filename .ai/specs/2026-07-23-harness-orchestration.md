...
Companion mockups: [`docs/mockups/harness-thread.html`](../../docs/mockups/harness-thread.html), [`harness-council.html`](../../docs/mockups/harness-council.html), [`harness-new-task.html`](../../docs/mockups/harness-new-task.html), [`harness-packets.html`](../../docs/mockups/harness-packets.html). Harness source of truth: [open-mercato/skills PR #43](https://github.com/open-mercato/skills/pull/43) (`skills/om-harness`).
...
## UI/UX
Design targets in `docs/mockups/` (same token sheet and shell as the existing five pages; dark default):
