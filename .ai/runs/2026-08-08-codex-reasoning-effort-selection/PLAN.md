...
|-------|------|-------|------|--------|--------|
| 1 | 1.1 | Discover and expose per-model Codex effort capabilities | inline | done | 3c46b22a |
| 1 | 1.2 | Add effort to contract, workflow, and persistent run schemas | inline | todo | — |
